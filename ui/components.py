"""
Apragyam v7.3.0 — Reusable UI components: metric cards, signal badges, headers, section headers.
...
def render_theme_toggle() -> None:
    ...
    st.components.v1.html(
        ...
        (function() {
            ...
            var saved = localStorage.getItem('apragyam-theme');
            ...
            window.toggleTheme = function() {
                ...
                localStorage.setItem('apragyam-theme', next);
                updateUI(next);
            };
