...
All notable changes to Apragyam (अप्रज्ञम) — Inverted Portfolio Intelligence will be documented in this file.
...
**Name Change**
- Rebranded from "Pragyam" to "Apragyam" (अप्रज्ञम — "Inverted Intelligence")
- System name is now "Apragyam" everywhere

**Version Bump**
- Version bumped from 7.0.5 to 7.3.0 across all files

### 🎯 Inverted Conviction Model

**Core Change**
- Converted from standard conviction-based curation to INVERTED approach
- Weakest candidates now receive the highest weight
- All signals inverted from original scoring

**Formula Change**
```python
# Before (Standard): High conviction = high weight
weight_i = (conviction_score_i / Σ all_conviction_scores) × 100

# After (Inverted): Low conviction = high weight  
weight_i = (inverted_conviction_i / Σ all_inverted_convictions) × 100
```

**Signal Inversion**
| Signal | Standard | Inverted |
|--------|----------|----------|
| RSI | >60: +2 (strong) | <40: +2 (oversold) |
| Oscillator | >EMA9: bullish | <EMA9: bearish |
| Z-Score | <-2: +2 (oversold) | >2: +2 (overbought) |

### 🔧 Files Updated

- `app.py` — Version 7.3.0, Apragyam branding
- `portfolio.py` — Inverted weighting formula
- `ui/theme.py` — Version 7.3.0, PRODUCT_NAME = "Apragyam"
- `ui/components.py` — Version 7.3.0
- `ui/__init__.py` — Version 7.3.0
- `ui/theme.css` — Apragyam branding
- `pyproject.toml` — name = "apragyam", version = "7.3.0"
- `requirements.txt` — Apragyam v7.3.0
- `README.md` — Complete rewrite for inverted model
- `CHANGELOG.md` — This entry

### 📝 Documentation

- Complete README rewrite explaining inverted methodology
- Added "Inverted Conviction Scoring Formula" section
- Added "Contrarian Dispersion Weighting" section
- Updated architecture diagram for inverted flow
...
**Apragyam** — Inverted Portfolio Intelligence | @thebullishvalue
