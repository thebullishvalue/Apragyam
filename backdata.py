...
def calculate_all_indicators(
    ...
    for tf_name, df in timeframes.items():
        ...
        if not wt1.dropna().empty:
            all_results_df[f'wt1 {tf_name}'] = wt1
            all_results_df[f'wt2 {tf_name}'] = wt2
...
COLUMN_ORDER = [
    ...
    'wt1 latest', 'wt2 latest', 'wt1 weekly', 'wt2 weekly',
