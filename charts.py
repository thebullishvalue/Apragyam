...
def create_conviction_heatmap(portfolio_with_signals: pd.DataFrame) -> go.Figure:
    ...
    WaveTrend (if available), and the composite Conviction score.
    ...
    # Add WaveTrend if available
    if "wt_signal" in df.columns:
        signal_cols.append("wt_signal")
        col_labels.append("WaveTrend")
